...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        if (candidate_id) {
            ...
            const annees_experience = calculateTotalExperience(candidat.experiences || []);
        ...
        console.log(`✅ Mise à jour terminée: ${updated} candidats mis à jour, ${errors.length} erreurs`);
